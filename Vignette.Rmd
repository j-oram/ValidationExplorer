...
- `parallel`: A logical indicating whether models should be fit in parallel (default setting is TRUE). If you have many datasets and many scenarios, we recommend this setting. 
...
visualize_single_parameter(sims_output, par = "theta[2, 3]", 
                           theta_scenario = 1, 
                           scenarios = 1:3, 
