...
- tests: A small directory containing scripts for automated tests. Current automated test coverage is 66%. Extensive manual testing has also been conducted for functions that don't allow automated tests.
