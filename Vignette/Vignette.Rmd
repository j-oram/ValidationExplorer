...
With `ValidationExplorer` installed, users have access to all the functions outlined in the appendix.
...
```{r tune, cache=TRUE}
tune_list <- tune_mcmc(
  dataset = sim_data$masked_dfs[[2]][[26]], 
  zeros = sim_data$zeros[[26]]
)
```
